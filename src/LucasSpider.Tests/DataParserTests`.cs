...
<div class='LucasSpider'>i am LucasSpider</div>
<div>
...
";
		...
		public async Task SingleEntitySelector()
		{
			...
			Assert.Equal("i am LucasSpider", results[0].LucasSpider);
		}
		...
		private class N : EntityBase<N>
		{
			...
			[ValueSelector(Expression = "./div[@class='LucasSpider']")]
			public string LucasSpider { get; set; }
		}
